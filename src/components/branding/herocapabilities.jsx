        ...
        <div className="flex w-full h-screen items-center justify-between px-[2rem]">
          <div className="w-4/10">
            <motion.h1
              ...
              className="max-[600px]:text-[3.5rem] text-[#212121] max-[1750px]:text-[4rem] text-[4.5vw] text-normal font-medium leading-[100%] tracking-[-0.1rem] overflow-hidden pt-0 md:pt-20"
            >
