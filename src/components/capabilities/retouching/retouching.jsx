...
const Retouching = () => {
  ...
  return (
    <>
      <HeroCapabilities
        headingTextOne="The Art of"
        headingTextTwo="Retouching"
        subheadingTextOne="Through retouching, we breathe life and"
        subheadingTextTwo="clarity into products, propelling them"
        subheadingTextThree="beyond their sales targets with passion"
        ...
        images2="/images/capabilities/Branding.jpg"
        images3="/images/capabilities/Design that speaks .jpg"
        images4="/images/capabilities/Capabilities.mp4"
        images5="/images/capabilities/rt1.jpg"
        images6="/images/capabilities/rt2.jpg"
          ...
          <div className="max-[600px]:mb-[1rem] max-[1024px]:mb-[4rem] w-full max-[1750px]:mb-[5rem] mb-[13rem]">
            ...
            >
              <span className="overflow-hidden">
                <span className="block">Exceed</span>
                <span className="block"> and Soar</span>
              </span>
            </p>
          </div>
          ...
          <div className="max-[1024px]:w-full w-[65%] flex flex-wrap">
            <div className="trigger-one-main w-full overflow-hidden">
              <p className="max-[600px]:hidden max-[600px]:mb-[3rem] max-[600px]:mt-[0rem] max-[600px]:text-[2rem] max-[1024px]:mb-[4rem] max-[1024px]:text-[2rem] max-[1024px]:leading-[120%] max-[1750px]:mb-[5rem] max-[1750px]:text-[3rem] text-[2.5vw] text-[#080808] font-normal leading-[140%] mb-[8rem] block">
                <span>We&apos;re passionate about elevating colors and crafting captivating combinations that soar.</span>
              </p>
            </div>
            <div className="max-[1024px]:w-[50%] w-[44.44%]">
              <p className="trigger-two-list  max-[600px]:text-[0.75rem] text-[#080808] text-xl font-medium leading-[180%] tracking-[-0.02rem] mb-[2rem] overflow-hidden">EDITING</p>
              <p className="trigger-two-list  max-[600px]:text-[0.75rem] text-[#080808] text-xl font-medium leading-[180%] tracking-[-0.02rem] mb-[2rem] overflow-hidden">PRODUCT DESIGN</p>
              <p className="trigger-two-list  max-[600px]:text-[0.75rem] text-[#080808] text-xl font-medium leading-[180%] tracking-[-0.02rem] mb-[2rem] overflow-hidden">PHOTOGRAPHY</p>
              <p className="trigger-two-list  max-[600px]:text-[0.75rem] text-[#080808] text-xl font-medium leading-[180%] tracking-[-0.02rem] mb-[2rem] overflow-hidden">VIDEO PRODUCT</p>
              <p className="trigger-two-list  max-[600px]:text-[0.75rem] text-[#080808] text-xl font-medium leading-[180%] tracking-[-0.02rem] mb-[2rem] overflow-hidden">MANIPULATION</p>
            </div>
            <div className="max-[1024px]:w-[50%] w-[44.44%]">
              <p className="trigger-two-list  max-[600px]:text-[0.75rem] text-[#080808] text-xl font-medium leading-[180%] tracking-[-0.02rem] mb-[2rem] text-[1rem] overflow-hidden">COLORING</p>
              <p className="trigger-two-list  max-[600px]:text-[0.75rem] text-[#080808] text-xl font-medium leading-[180%] tracking-[-0.02rem] mb-[2rem] text-[1rem] overflow-hidden">PHOTO EDITING</p>
