...
const Branding = () => {
  ...
  return (
    <>
      <HeroCapabilities
        headingTextOne="Design That"
        headingTextTwo="Inspires You!"
        subheadingTextOne="From designing internal decks to"
        subheadingTextTwo="developing 360 rebranding campaigns,"
        subheadingTextThree="we focus on creating solution-driven"
      ...
      <section className="w-full h-full [background:#82CAAA] text-black rounded-t-lg px-6 lg:px-0" id="digital-experience-scroller">
        <div className="sm:container sm:mx-auto lg:mx-16 max-[600px]:pt-[3.5rem] max-[600px]:pb-[2rem] max-[1024px]:pb-[5rem] w-full flex flex-wrap pt-[5rem]" id="digital-experience-scroller-inner">
          ...
          <div className="max-[1024px]:w-full w-[65%] flex flex-wrap">
            <div className="trigger-one-main w-full overflow-hidden">
              <p className="max-[600px]:hidden max-[600px]:mb-[3rem] max-[600px]:mt-[0rem] max-[600px]:text-[2rem] max-[1024px]:mb-[4rem] max-[1024px]:text-[2rem] max-[1024px]:leading-[120%] max-[1750px]:mb-[5rem] max-[1750px]:text-[3rem] text-[2.5vw] text-[#080808] font-normal leading-[140%] mb-[8rem] block">
                <span>We ensure the visual impact of every project is maximized for each brand we collaborate with.</span>
              </p>
            </div>
            <div className="max-[1024px]:w-[50%] w-[44.44%]">
              <p className="trigger-two-list  max-[600px]:text-[0.75rem] text-[#080808] text-xl font-medium leading-[180%] tracking-[-0.02rem] mb-[2rem] overflow-hidden">BRANDING</p>
              <p className="trigger-two-list  max-[600px]:text-[0.75rem] text-[#080808] text-xl font-medium leading-[180%] tracking-[-0.02rem] mb-[2rem] overflow-hidden">LOGOS</p>
              <p className="trigger-two-list  max-[600px]:text-[0.75rem] text-[#080808] text-xl font-medium leading-[180%] tracking-[-0.02rem] mb-[2rem] overflow-hidden">DESIGN</p>
              <p className="trigger-two-list  max-[600px]:text-[0.75rem] text-[#080808] text-xl font-medium leading-[180%] tracking-[-0.02rem] mb-[2rem] overflow-hidden">IDENTITY</p>
              <p className="trigger-two-list  max-[600px]:text-[0.75rem] text-[#080808] text-xl font-medium leading-[180%] tracking-[-0.02rem] mb-[2rem] overflow-hidden">RESEARCH</p>
            </div>
            <div className="max-[1024px]:w-[50%] w-[44.44%]">
              <p className="trigger-two-list  max-[600px]:text-[0.75rem] text-[#080808] text-xl font-medium leading-[180%] tracking-[-0.02rem] mb-[2rem] text-[1rem] overflow-hidden">CHARACTER DESIGN</p>
              <p className="trigger-two-list  max-[600px]:text-[0.75rem] text-[#080808] text-xl font-medium leading-[180%] tracking-[-0.02rem] mb-[2rem] text-[1rem] overflow-hidden">CONTENT</p>
              <p className="trigger-two-list  max-[600px]:text-[0.75rem] text-[#080808] text-xl font-medium leading-[180%] tracking-[-0.02rem] mb-[2rem] text-[1rem] overflow-hidden">SOCIAL MEDIA</p>
              <p className="trigger-two-list  max-[600px]:text-[0.75rem] text-[#080808] text-xl font-medium leading-[180%] tracking-[-0.02rem] mb-[2rem] text-[1rem] overflow-hidden">DIGITAL CAMPAIGNS</p>
            </div>
          </div>
        </div>
      </section>
